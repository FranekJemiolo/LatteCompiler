...
instance Print TopDef where
  prt i e = case e of
    ...
    ClassExtDef id1 id2 propertys -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 propertys, doc (showString "}")])
    ClassDef id propertys -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 propertys, doc (showString "}")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Property where
  prt i e = case e of
    FnProp fndef -> prPrec i 0 (concatD [prt 0 fndef])
    AttrProp type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print Type where
  prt i e = case e of
    ...
    Arr type_ n -> prPrec i 0 (concatD [prt 0 type_, doc (showString "["), prt 0 n, doc (showString "]")])
    Pointer type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "*")])
    VTable id -> prPrec i 0 (concatD [prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Expr where
  prt i e = case e of
    ...
    ENewCls type_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_])
    ...
    EPropApp expr id exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id, doc (showString "("), prt 0 exprs, doc (showString ")")])
    EProp expr id -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id])
    EArrGet expr1 expr2 -> prPrec i 6 (concatD [prt 6 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    ENullCast id -> prPrec i 6 (concatD [doc (showString "("), prt 0 id, doc (showString ")"), doc (showString "null")])
